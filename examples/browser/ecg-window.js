export function renderEcgWindow(container, payload, options = {}) {
  ...
  container.innerHTML = `
    <div style="${panelStyle()}">
      ...
      <div style="display:grid; gap:0.15rem; justify-items:end; white-space:nowrap;">
        ...
        <div style="font-size:1.8rem; font-weight:700; line-height:1; color:#f9fafb;">${percentageLabel}</div>
...
export function startEcgWindowPolling({ container, fetchPayload, intervalMs = 1500, width = 320, height = 72 }) {
  let stopped = false;
  let timerId = null;
